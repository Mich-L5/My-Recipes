...
<body>
    ...
    <!-- welcome popup -->
    <div id="welcome-popup-overlay" class="popup-overlay hidden">
        <div id="welcome-popup" class="popup">
            <h2>Welcome!</h2>
            <p>Welcome to the Recipe Book app! You are currently in demo mode. Feel free to try the app by adding new recipes!</p>
